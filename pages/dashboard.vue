        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 mb-8">
          ...
          <div class="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
            ...
            <div class="px-6 py-4">
              ...
              <div class="mt-6">
                <NuxtLink  to='savings' class="w-full flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-colors duration-150">
                  View all
                </NuxtLink>
              </div>
            </div>
